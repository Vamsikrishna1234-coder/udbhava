    ...
    >
      <motion.div
        style={{
          ...
          height: 400,
          borderRadius: "50%",
          border: "1px solid rgba(216,92,38,0.15)", // UPDATED
          y,
        }}
      />
      <motion.div
        style={{
          ...
          height: 500,
          borderRadius: "50%",
          border: "1px solid rgba(216,92,38,0.1)", // UPDATED
      ...
      >
        ...
        <div>
          ...
          >
            <motion.div
              ...
              style={{
                ...
                height: 8,
                borderRadius: "50%",
                background: "#d85c26", // UPDATED
                boxShadow: "0 0 12px rgba(216,92,38,0.5)", // UPDATED
              }}
            />
            <span
              style={{
          ...
          <div style={{ overflow: "hidden", marginBottom: 32 }}>
            ...
            >
              <span style={{ fontStyle: "italic", color: "#d85c26" }}> {/* UPDATED */}
                Excellence
              </span>{" "}
              Since 2009
            </motion.h2>
          ...
          >
            Our multidisciplinary team blends innovation, sustainability and
            aesthetics.
          </motion.p>
          ...
          <motion.a
            ...
            style={{
              ...
              textTransform: "uppercase",
              padding: "16px 38px",
              border: "1.5px solid #d85c26", // UPDATED
              color: "#d85c26", // UPDATED
              textDecoration: "none",
              transition: "all 0.3s",
            }}
          >
            <span className="absolute inset-0 w-full h-full bg-[#d85c26] translate-x-[-100%] group-hover:translate-x-0 transition-transform duration-500 ease-out"></span>
